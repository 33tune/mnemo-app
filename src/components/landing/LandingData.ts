/* ════════ myLand — content data (TypeScript) ════════ */

export interface GBEntry {
  name: string;
  time: string;
  art: string;
  text: string;
...
export const HERO_ELS: CanvasElDef[] = [
...
export const LIST_ROWS = ["instagram", "twitter / x", "my newsletter", "shop", "spotify", "youtube"];
