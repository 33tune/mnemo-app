...
import type { CanvasElDef } from "./LandingData";

function Avatar({ art = "art-dusk", size = 64, ring = "rgba(255,255,255,0.15)" }: { art?: string; size?: number; ring?: string }) {
  return (
...
function ImageEl({ data }: { data: CanvasElDef }) {
  return (
...
export function GifEl({ data }: { data: CanvasElDef }) {
...
function ProfileCardEl({ data }: { data: CanvasElDef }) {
...
export function GuestbookEl({ data }: { data: CanvasElDef }) {
...
export function MediaEl({ data }: { data: CanvasElDef }) {
...
export function NoteEl({ data }: { data: CanvasElDef }) {
  return (
...
export function LinkPillEl({ data }: { data: CanvasElDef }) {
  return (
...
function TextEl({ data }: { data: CanvasElDef }) {
  return (
...
function PhotoEl({ data }: { data: CanvasElDef }) {
  return (
...
function CodeEl({ data }: { data: CanvasElDef }) {
...
function StickerEl({ data }: { data: CanvasElDef }) {
  return (
    <div className="cel" style={{ width: data.w, height: data.h }}>
...
function KaoEl({ data }: { data: CanvasElDef }) {
  return (
...
function BannerEl({ data }: { data: CanvasElDef }) {
  return (
...
export function CanvasEl({ el }: { el: CanvasElDef }) {
  switch (el.type) {
