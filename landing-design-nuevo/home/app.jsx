...
/* ─────────── claim field (max-hierarchy element, reused) ─────────── */
...
function ClaimField({ id, autoFocus }) {
  ...
  return (
    <header className={"topbar " + (solid ? "solid" : "")}>
      <a href="#top" className="brand">
        <img src="home/assets/logo.png" alt="myLand" />
        <span>myLand</span>
      </a>
      <nav className="nav">
...
/* ─────────── fanned "land" cards (abstract gradient-grain, bleed off right) ─────────── */
const FAN = [
...
function Fan() {
  return (
    <div className="fan desk" style={{ right: -90, top: "50%", transform: "translateY(-46%)", width: 700, height: 320 }} aria-hidden="true">
      {FAN.map((c, i) => (
...
/* ─────────── explore ─────────── */
/* Placeholder slots — wired to real "most viewed" data later:
   query profiles+canvases, order by get_profile_view_stats(total) desc, take 15.
   NO AI imagery: each thumb is a clearly-marked placeholder until real previews load. */
const TINTS = [
...
/* ─────────── pricing (placeholder structure — tiers TBD) ─────────── */
const PLANS = [
  ...
  return (
    <section className="rev" style={{ position: "relative", padding: "120px 32px 60px", textAlign: "center", overflow: "hidden" }}>
      ...
      <div className="wrap" style={{ display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 1 }}>
        <img src="home/assets/logo.png" alt="" style={{ width: 64, height: "auto", marginBottom: 22 }} />
      ...
      <footer style={{ marginTop: 110, paddingTop: 26, borderTop: "1px solid var(--hair)", maxWidth: 1116, marginInline: "auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 }}>
        <div className="brand"><img src="home/assets/logo.png" alt="" style={{ width: 22 }} /><span style={{ fontSize: 15 }}>myLand</span></div>
