...
/* hero guestbook entries (short, human, old-web) */
const HERO_GB = [
...
/* neve's space — a dense, authored room (dominant + secondary + many small details), on a 1240x720 stage */
const HERO_ELS = [
  // hand-authored welcome banner (top of the room)
  { id: "banner", type: "banner", text: "welcome to my corner ✦", sub: "neve's space · est. 2024", w: 320, x: 590, y: 30, rot: -1, depth: 0.42, z: 9, li: 0 },

  // ★ DOMINANT — the profile card, anchoring the room
  { id: "p1", type: "profile", name: "neve", handle: "neve", status: "building a quiet place on the loud internet",
    followers: "3.4k", following_n: "212", following: true, art: "art-violet", avatarArt: "art-rose",
    w: 246, h: 314, x: 612, y: 150, rot: -2, depth: 0.30, z: 6, li: 2 },

  // big photo bleeding off the top-right edge
  { id: "phBig", type: "photo", scene: "scene-portrait", film: "portra 400", caption: "self, dec", w: 244, h: 298,
    x: 868, y: -44, rot: 3, depth: 0.52, z: 3, li: 1 },

  // pinned photo cluster, overlapping the profile's left
  { id: "ph2", type: "photo", scene: "scene-night", film: "35mm", caption: "berlin · 3am", w: 184, h: 148,
    x: 540, y: 262, rot: -6, depth: 0.70, z: 4, li: 3 },
  { id: "ph3", type: "photo", scene: "scene-fog", film: "", w: 150, h: 120,
    x: 560, y: 360, rot: 5, depth: 0.72, z: 5, li: 4 },
  { id: "stk1", type: "sticker", shape: "star", w: 34, h: 34, x: 600, y: 300, rot: -12, depth: 0.92, z: 8, li: 5 },

  // guestbook cluster, bleeding off the right edge, scraps pinned over it
  { id: "gb", type: "guestbook", total: "2,481", messages: HERO_GB, w: 252, h: 330,
    x: 1012, y: 152, rot: 2, depth: 0.42, z: 4, li: 2 },
  { id: "nPink", type: "note", tone: "pink", text: "happy bday neve!! 🎂", size: 13, w: 142, h: 80,
    x: 970, y: 116, rot: -8, depth: 0.95, z: 7, li: 6 },
  { id: "gf1", type: "gif", gif: "gif-aura", w: 92, h: 92, x: 1186, y: 438, rot: 6, depth: 0.98, z: 7, li: 7 },

  // media + links cluster, lower
  { id: "m1", type: "media", track: "Strawberry Switchblade", artist: "Since Yesterday", art: "art-ember",
    w: 246, h: 80, x: 616, y: 504, rot: -2, depth: 0.55, z: 5, li: 5 },
  { id: "l1", type: "link", label: "read my zine", art: "art-ice", w: 170, x: 540, y: 482, rot: -3, depth: 0.60, z: 6, li: 6 },
  { id: "l2", type: "link", label: "my photos", art: "art-rose", w: 150, x: 540, y: 532, rot: 2, depth: 0.62, z: 6, li: 7 },

  // … many small details scattered through the room
  { id: "kao1", type: "kao", text: "(｡•ᴗ•｡)♡", size: 26, color: "#ffd2e6", w: 150, x: 876, y: 298, rot: -4, depth: 1.0, z: 8, li: 6 },
  { id: "kao2", type: "kao", text: ".: ☆ *:･ﾟ", size: 15, color: "#cfe6ff", w: 110, x: 548, y: 214, rot: 0, depth: 1.0, z: 8, li: 5 },
  { id: "ts", type: "kao", text: "♡ 2,481 visits · 3 online", size: 10, color: "rgba(255,255,255,0.72)", w: 220, x: 876, y: 262, rot: 0, depth: 0.85, z: 8, li: 6 },
  { id: "stk2", type: "sticker", shape: "heart", w: 26, h: 26, x: 974, y: 332, rot: -10, depth: 1.05, z: 8, li: 7 },
  { id: "stk3", type: "sticker", shape: "star", w: 24, h: 24, x: 1152, y: 120, rot: 14, depth: 1.05, z: 8, li: 7 },
];

/* the rigid "list" that blooms away — uniform rows, centered */
const LIST_ROWS = ["instagram", "twitter / x", "my newsletter", "shop", "spotify", "youtube"];

/* full guestbook feed for the spotlight section */
const GB_FEED = [
  { name: "mara",    time: "2m",  art: "art-rose",   text: "your room is so cozy i never want to leave" },
...
/* demo gallery spaces — each a dense, lived-in room with its own subculture & wallpaper */
const GALLERY = [
...
/* pricing — themed to the land metaphor; scaffolded for future subscriptions */
const PLANS = [
...
Object.assign(window, { HERO_ELS, HERO_GB, LIST_ROWS, GB_FEED, GALLERY, PLANS });
